...
# Streamlit 애플리케이션 제목
st.set_page_config(page_title="Map",layout="wide",  page_icon="🗺️")
...
with col2:
    ...
    df = pd.read_csv("./data/민원데이터_전체통합_주소완료_1003.csv")
    df1 = pd.read_csv("./data/전국_교통사고_민원포함_긍부정요인완료_1017.csv")
